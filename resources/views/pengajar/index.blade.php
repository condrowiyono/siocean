    ...
    <div class="row">
        <div class="col-md-4">
            <div class="panel panel-default">
                ...
                @if (auth()->user()->id==$user->biodata->id)
                    <a href="pengajar/edit" class="btn btn-blocked btn-success"><span class="fa fa-edit"></span> </a>
                @endif
                {{$user->biodata->nama}}
                </h4>
                <h5>
                ...
                <h6>
                  <i class="fa fa-university fa-fw"></i>{{$user->instansi}}</h4>
                </div>
            </div>
            <div class="panel panel-default">
            <div class="panel-body">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <a href="{{route('paket.index')}}" class="btn btn-success">Paket</a>
                </div>
            </div>
        </div>
    </div>
