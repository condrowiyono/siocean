    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">Edit Pengajar</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('pengajar/update') }}">
                        ...
                        <div class="form-group{{ $errors->has('instansi') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="instansi" type="text" class="form-control" name="instansi" value="{{ $user->instansi }}" required autofocus>
