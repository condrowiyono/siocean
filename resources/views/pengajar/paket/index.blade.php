...
<div class="container">
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            Paket
                <a href="{{route('paket.create')}}" class="btn btn-primary pull-right"> BUAT BARU</a>
                <div class="">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form method="POST" action="{{route('paket.destroy', $data->id)}}" accept-charset="UTF-8">
                            <input name="_method" type="hidden" value="DELETE">
                            <input name="_token" type="hidden" value="{{ csrf_token() }}">
                            <a href="{{route('paket.edit', $data->id)}}" class="btn-raised btn btn-primary">EDIT</a>
                            <input type="submit" class="btn btn-danger" value="HAPUS">
                            <a href="{{route('nilai.show', $data->id)}}" class="btn-raised btn btn-primary">DAFTAR NILAI</a>
                        </form>
                        </td>
                    </tr>
                    @endforeach
