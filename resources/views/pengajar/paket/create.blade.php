        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('paket.store') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('pelajaran') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="pelajaran" type="text" class="form-control" name="pelajaran" value="{{ old('pelajaran') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('tahun') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="tahun" type="text" class="form-control" name="tahun" value="{{ old('tahun') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('jadwal_mulai') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="jadwal_mulai" type="text" class="form-control" name="jadwal_mulai" value="{{ old('jadwal_mulai') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('jadwal_selesai') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="jadwal_selesai" type="text" class="form-control" name="jadwal_selesai" value="{{ old('jadwal_selesai') }}" required>
